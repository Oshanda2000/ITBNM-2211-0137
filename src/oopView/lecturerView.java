...
import oopController.lecturercontroller;
...
public class lecturerView extends javax.swing.JFrame {
    ...
    public lecturerView() {
     ...
     DefaultTableModel model = (DefaultTableModel) lecturertable.getModel();
            ...
            List<String[]> userData = dao.getAlllecturer();
    ...
    private void initComponents() {
        ...
        lecturertable.setBackground(new java.awt.Color(41, 151, 219));
        lecturertable.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/video-presentation_250-removebg-preview.png"))); // NOI18N
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        lecturer.setName(name.getText());
        lecturer.setAddress(address.getText());
        lecturer.setAge(age.getText());
        lecturer.setBirthday(birthday.getText());
        lecturer.setContact(contact.getText());
        lecturer.setGender((String)gender.getSelectedItem());

        lecturerDao pt = new lecturerDao();
        pt.addlecturer(lecturer);
...
//        }
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int id = Integer.parseInt(lecturertable.getValueAt(selectedRow, 0).toString());
     ...
     //   System.out.print(id);
        ...
        if (JOptionPane.showConfirmDialog(this, "Are you sure you want to delete?", "Delete Confirmation", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                ...
                lecturercontroller controller = new lecturercontroller(this); // Assuming an instance creation mechanism
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        // TODO add your handling code here:
       int id = Integer.parseInt(lecturertable.getValueAt(lecturertable.getSelectedRow(), 0).toString());
        ...
        lecturercontroller controller = new lecturercontroller(this); 
    ...
    private void lecturertableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lecturertableMouseClicked
        ...
        DefaultTableModel tableModel = (DefaultTableModel) lecturertable.getModel();

    if (lecturertable.getSelectedRow() != -1) {
        // Check if a row is selected
        
           int ID = Integer.parseInt(tableModel.getValueAt(lecturertable.getSelectedRow(), 0).toString());     
            String NAME = tableModel.getValueAt(lecturertable.getSelectedRow(), 1).toString();
            String ADDRESS = tableModel.getValueAt(lecturertable.getSelectedRow(),2).toString();
            String AGE = tableModel.getValueAt(lecturertable.getSelectedRow(), 3).toString();
            String BIRTHDAY = tableModel.getValueAt(lecturertable.getSelectedRow(), 4).toString();
            String GENDER = tableModel.getValueAt(lecturertable.getSelectedRow(), 5).toString();
            String CONTACT = tableModel.getValueAt(lecturertable.getSelectedRow(), 6).toString();
